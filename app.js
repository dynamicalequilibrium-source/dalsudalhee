...
- Dalhee (달희): Always has mushroom-shaped dark brown hair (#604C3F) with very thick, heavy bangs that COMPLETELY HIDE her forehead, eyes, and eyebrows. Her eyes must NEVER be visible - not even partially. The hair must drape down far enough to fully conceal where the eyes would be. Only her nose area and smiling mouth line should be visible on her face. This is her most critical defining feature.
...
- Framing & Composition: The character must be drawn as a FULL BODY portrait with generous white padding on ALL sides (top, bottom, left, right). Leave at least 15% margin space around the character. The character's head, hair, hands, and feet must NEVER be cropped or cut off by the image edges. Center the character in the frame.
...
- 달희(Dalhee): 이마와 눈을 완전히 덮는 두꺼운 갈색 버섯 모양 머리카락. 눈과 눈썹이 절대로 보여서는 안 됩니다. 머리카락이 눈 위치를 완전히 가려야 하며, 코 부근과 웃는 입선만 얼굴에서 보여야 합니다. 이것이 달희의 가장 핵심적인 캐릭터 특징입니다.
...
- 프레임 구도: 캐릭터를 전신 초상화로 그리되, 상하좌우 모든 방향에 충분한 흰색 여백(최소 15%)을 두십시오. 머리카락 꼭대기, 손, 발이 이미지 가장자리에 잘리지 않도록 캐릭터를 프레임 중앙에 배치하십시오.
- 배경 및 그림자: 배경과 바닥은 완전히 깨끗한 단색 흰색(#FFFFFF)이어야 하며, 발밑에 타원형 회색 바닥 그림자나 어떠한 바닥 음영 표현도 그리지 말고 제거하십시오.`;
    ...
    if (appState.activeCharacter === 'dalsu') {
      styleReinforcement = "\n\n(Subject Details: Dalsu is a 2-head-tall chibi mascot with short chubby limbs. He has fluffy, cloud-shaped dark brown hair covering his entire head, two dot eyes, and a cute smiling mouth line. Keep his original outfit and appearance exactly as shown in the reference image. Only change his pose to match the requested scene. Do NOT redesign his clothes, hair, face, or body proportions. IMPORTANT: Draw full body with generous white margins on all sides. Do NOT crop the top of his head or any body part. Seamless solid white background with absolutely no ground shadows or ellipses under his feet.)";
    } else if (appState.activeCharacter === 'dalhee') {
      styleReinforcement = "\n\n(Subject Details: Dalhee is a 2-head-tall chibi mascot with short chubby limbs. She has mushroom-shaped dark brown hair with very thick, heavy bangs that COMPLETELY HIDE her eyes - her eyes must NEVER be visible, not even partially. Only her nose area and smiling mouth line are visible on her face. Keep her original outfit and appearance exactly as shown in the reference image. Only change her pose to match the requested scene. Do NOT redesign her clothes, hair, face, or body proportions. IMPORTANT: Draw full body with generous white margins on all sides. Do NOT crop the top of her head or any body part. Seamless solid white background with absolutely no ground shadows or ellipses under her feet.)";
    } else if (appState.activeCharacter === 'both') {
      styleReinforcement = "\n\n(Subject Details: Both Dalsu (left) and Dalhee (right) are 2-head-tall chibi mascot characters with short chubby limbs side-by-side. Dalsu has fluffy, cloud-shaped dark brown hair covering his head, two dot eyes, and a smiling mouth line. Dalhee has mushroom-shaped dark brown hair with very thick, heavy bangs that COMPLETELY HIDE her eyes - her eyes must NEVER be visible. Only her nose area and smiling mouth line are visible on her face. Keep both characters' original outfits and appearances exactly as shown in the reference images. Only change their poses to match the requested scene. Do NOT redesign their clothes, hair, faces, or body proportions. IMPORTANT: Draw full bodies with generous white margins on all sides. Do NOT crop the top of heads or any body parts. Seamless solid white background with absolutely no ground shadows or ellipses under their feet.)";
    }
